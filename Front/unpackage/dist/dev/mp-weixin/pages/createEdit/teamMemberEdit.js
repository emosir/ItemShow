...
var _teamMemberEdit = _interopRequireDefault(__webpack_require__(/*! ./pages/createEdit/teamMemberEdit.vue */ 38));
// @ts-ignore
...
/* harmony import */ var _teamMemberEdit_vue_vue_type_template_id_05d32ae1_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./teamMemberEdit.vue?vue&type=template&id=05d32ae1&scoped=true& */ 39);
/* harmony import */ var _teamMemberEdit_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./teamMemberEdit.vue?vue&type=script&lang=js& */ 41);
...
var _teamMember = _interopRequireDefault(__webpack_require__(/*! ../../api/teamMember */ 43));
...
var _default = {
  ...
  onLoad: function onLoad(option) {
    ...
    _teamMember.default.getTeamMembers(this.team.id).then(function (res) {
      ...
      _showsOpe.default.getHeadImages(_this.members).then(function (res) {
        _this.members = res;
      });
    }).catch(function (err) {
      console.log(err);
  ...
  methods: {
    ...
    searchUser: function searchUser() {
      _teamMember.default.invite(this.userIdFormData.userId, this.team.id).then(function (res) {
        _popup.default.showSuccess("邀请已发送");
      }).catch(function (err) {
        _popup.default.showError(err.msg);
      });
    },
    ...
    pickerChange: function pickerChange(e, index, s) {
      ...
      _teamMember.default.jobChange(this.members[index].id, this.team.id, s).then(function () {
        _this2.members[index].positionIndex = e.detail.value;
      }).catch(function (err) {
    ...
    deleteMember: function deleteMember(index) {
      ...
      _popup.default.showConfirmAndCancel("确认删除该成员吗？", "成员名：" + this.members[index].name, function () {
        _teamMember.default.removeMember(_this3.members[index].id, _this3.team.id).then(function () {
